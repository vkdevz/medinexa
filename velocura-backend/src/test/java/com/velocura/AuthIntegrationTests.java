...
class AuthIntegrationTests {
    ...
    void testAuthenticationAndAuthorizationFlow() throws Exception {
        ...
        RegisterRequest registerRequest = RegisterRequest.builder()
                .email("testpatient@velocura.com")
        ...
        assertTrue(userRepository.existsByEmail("testpatient@velocura.com"));
        var userOpt = userRepository.findByEmail("testpatient@velocura.com");
        ...
        assertEquals("testpatient@velocura.com", authResponse.getEmail());
