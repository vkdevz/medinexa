...
const PatientDashboard = () => {
  ...
  const [chatHistory, setChatHistory] = useState([
    {
      sender: 'bot',
      text: "Hello! I am your MediNexa AI Symptom Advisor. Describe your symptoms (e.g. 'I have chest pressure and palpitations' or 'I have a sore throat and mild fever'), and I will analyze triage risk and suggest booking matching specialists."
    }
  ]);
      ...
      <div className="flex-1 flex flex-col md:flex-row z-10">
        ...
        <aside className="w-full md:w-64 bg-slate-900/40 border-r border-slate-900 px-6 py-8 flex flex-col shrink-0">
          <div className="flex items-center space-x-3 mb-8">
            ...
            <div>
              <span className="text-lg font-bold tracking-tight text-white">MediNexa</span>
          ...
          {activeTab === 'overview' && (
            <div className="space-y-8">
              <div className="glass-card rounded-3xl p-8 relative overflow-hidden">
                ...
                <p className="text-slate-400 mt-2 text-sm leading-relaxed max-w-xl">
                  Welcome to your MediNexa Healthcare Workspace. Chat with our AI Triage Advisor for immediate symptoms triage, track your vitals over time, or check active e-prescriptions.
                </p>
