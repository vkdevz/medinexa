      ...
      <div className="flex-1 flex flex-col md:flex-row z-10">
        ...
        <aside className="w-full md:w-64 bg-slate-900/40 border-r border-slate-900 px-6 py-8 flex flex-col shrink-0">
          <div className="flex items-center space-x-3 mb-8">
            ...
            <div>
              <span className="text-lg font-bold tracking-tight text-white font-sans">MediNexa</span>
          ...
          <div className="border-t border-slate-900 pt-6 mt-6">
            <div className="flex items-center space-x-3 mb-4">
              ...
              <div className="overflow-hidden">
                ...
                <p className="text-xs text-slate-500 truncate font-mono">admin@medinexa.com</p>
              </div>
            </div>
            <button
              onClick={logout}
            ...
            <div className="space-y-8">
              ...
              <div className="glass-card rounded-3xl p-8 relative overflow-hidden">
                ...
                <p className="text-slate-400 mt-2 text-sm leading-relaxed max-w-xl">
                  Welcome to the MediNexa System Administration Workspace. You can monitor platform performance, verify medical credentials, and audit active users.
                </p>
              </div>
